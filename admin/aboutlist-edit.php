...
if(isset($_POST['update'])) {
       ...
       $list = $_POST['LIST'];
       $id = $_POST['ID'];
       $sql = "UPDATE aboutlist SET LIST= '{$list}' WHERE ID = {$id}";
...
<!--ending of navbar -->
  ...
  <div class="container">
    <h1 style="color:#0c3">Edit About-Us List</h1>

   <?php 
   $id = $_GET['ID'];
   $sql1 = "SELECT * FROM aboutlist WHERE ID = {$id}";
  ...
  ?>
     <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
       ...
       <div class="form-group">
          ...
          <input type="text" class="form-control" name="LIST" value="<?php echo $row1['LIST'];?>" required>
       </div>
